...
def telegram_bot():
  ...
  if message == "/start":
    ...
    texto_resposta = "Acbo que digitou errado! Digite 'menu' para voltar ao começou ou para outras informações sobre a cidade de São Paulo, acesse o site da Agência Mural: agenciamural.org.br"
